...
Download **0.1.5** from:
https://github.com/Tyler-Hughes312/mycelium/releases/tag/v0.1.5-desktop

| Platform | Asset |
|---|---|
| macOS (Apple Silicon) | [`Mycelium_0.1.5_aarch64.dmg`](https://github.com/Tyler-Hughes312/mycelium/releases/download/v0.1.5-desktop/Mycelium_0.1.5_aarch64.dmg) |
| Windows (x64) | [`Mycelium_0.1.5_x64-setup.exe`](https://github.com/Tyler-Hughes312/mycelium/releases/download/v0.1.5-desktop/Mycelium_0.1.5_x64-setup.exe) |
